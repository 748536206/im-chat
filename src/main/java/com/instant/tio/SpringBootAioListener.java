...
public class SpringBootAioListener extends WsServerAioListener {
    ...
    private static Logger log = LoggerFactory.getLogger(SpringBootAioListener.class);
    public static final SpringBootAioListener me = new SpringBootAioListener();
    private SpringBootAioListener() {
    }
    @Override
